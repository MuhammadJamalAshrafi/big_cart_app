...
class Assets {
  ...
  static String splashScreenBackground =
      Constants.imageAssetPath + 'splash_bg.png';
  static String logo = Constants.imageAssetPath + 'logo.png';
  static String loginBackground = Constants.imageAssetPath + 'login_bg.png';
  static String backArrow = Constants.imageAssetPath + 'back-arrow.png';
